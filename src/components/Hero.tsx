...
const Hero = () => {
  ...
  const [lines, setLines] = useState<
    Array<{x1: number; y1: number; x2: number; y2: number; opacity: number; strokeWidth: number}>
  >([]);
  ...
  const tabs = [
    {
      ...
      description:
        'Create unlimited e-commerce stores without any cost. No hidden fees, no premium tiers - just pure freedom to build your dream shop.',
    ...
    },
    {
      ...
      description:
        'Get all the powerful features of premium platforms without spending a dime. Professional templates, payment processing, and analytics included.',
    ...
    },
    {
      ...
      description:
        'Scale your business without worrying about transaction fees or monthly subscriptions. Your success is our success.',
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (containerRef.current) {
        ...
        const diagonalPoints = [
          ...
          {x: 0, y: rect.height},
          {x: rect.width / 4, y: 0},
          {x: (rect.width * 3) / 4, y: rect.height},
          {x: 0, y: rect.height / 4},
          {x: rect.width, y: (rect.height * 3) / 4},
        ];
  ...
  const themeColors = {
    gradient: isPulseDark ? 'from-black via-gray-950 to-gray-900' : 'from-black via-red-950 to-gray-900',
  ...
  return (
    <div
      ...
      <div
        className={`absolute inset-0 transition-all duration-[1500ms] ease-in-out ${themeColors.radialAccents[0]}`}></div>
      <div
        className={`absolute inset-0 transition-all duration-[1500ms] ease-in-out ${themeColors.radialAccents[1]}`}></div>
      <div
        className={`absolute inset-0 transition-all duration-[1500ms] ease-in-out ${themeColors.radialAccents[2]}`}></div>
      ...
      <div className="absolute inset-0 overflow-hidden transition-all duration-[1500ms] ease-in-out">
        ...
        <div
          className={`absolute -top-1/2 -left-1/2 w-full h-full transition-all duration-[1500ms] ease-in-out rounded-full animate-pulse-slow ${
            isPulseDark
        ...
        <div
          className={`absolute -bottom-1/2 -right-1/2 w-full h-full transition-all duration-[1500ms] ease-in-out rounded-full animate-pulse delay-1000 ${
            isPulseDark
        ...
        <div
          className={`absolute top-1/4 left-1/4 w-32 h-32 transition-all duration-[1500ms] ease-in-out rounded-full blur-xl animate-float-slow ${
            isPulseDark
              ? 'bg-gradient-to-r from-gray-500/25 to-gray-600/20'
              : 'bg-gradient-to-r from-red-500/25 to-red-600/20'
          }`}></div>
        <div
          className={`absolute bottom-1/3 right-1/3 w-24 h-24 transition-all duration-[1500ms] ease-in-out rounded-full blur-lg animate-float delay-2000 ${
            isPulseDark
        ...
        <div
          className={`absolute inset-0 transition-all duration-[1500ms] ease-in-out animate-grid-move ${
            isPulseDark
        ...
        <div
          className={`absolute top-20 left-10 w-2 h-2 rounded-full animate-bounce-slow transition-all duration-[1500ms] ease-in-out ${
            isPulseDark ? 'bg-gray-500/70' : 'bg-red-500/70'
          }`}></div>
        <div
          className={`absolute top-32 right-16 w-1.5 h-1.5 rounded-full animate-bounce delay-500 transition-all duration-[1500ms] ease-in-out ${
        ...
        <div className="absolute top-1/4 right-1/4 animate-spin-slow">
          <div className="relative w-16 h-16">
            <div
              className={`absolute inset-0 opacity-60 blur-lg rotate-45 animate-pulse transition-all duration-[1500ms] ease-in-out ${
                isPulseDark ? 'bg-gradient-to-r from-gray-500 to-gray-700' : 'bg-gradient-to-r from-red-500 to-red-700'
              }`}></div>
            <div
              className={`absolute inset-2 rotate-45 shadow-lg transition-all duration-[1500ms] ease-in-out ${
                isPulseDark
            ...
            <div
              className={`absolute inset-4 rotate-45 opacity-80 transition-all duration-[1500ms] ease-in-out ${
                isPulseDark
        ...
        <div className="absolute bottom-1/4 left-1/4 animate-spin-reverse">
          <div className="relative w-12 h-12">
            <div
              className={`absolute inset-0 opacity-70 blur-md transition-all duration-[1500ms] ease-in-out ${
                isPulseDark ? 'bg-gradient-to-r from-gray-700 to-gray-900' : 'bg-gradient-to-r from-red-700 to-red-900'
              }`}
              style={{clipPath: 'polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)'}}></div>
            <div
              className={`absolute inset-2 transition-all duration-[1500ms] ease-in-out ${
                isPulseDark
              ...
              style={{clipPath: 'polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)'}}></div>
            <div
              className={`absolute inset-4 opacity-90 animate-pulse transition-all duration-[1500ms] ease-in-out ${
      ...
      <div className="relative z-20 space-y-12 max-w-6xl mx-auto">
        ...
        <div className="animate-slide-up delay-300">
          <div className="relative">
            ...
            <div
              className={`absolute inset-0 text-4xl md:text-5xl lg:text-6xl font-light text-transparent bg-clip-text animate-gradient-shift opacity-60 transition-all duration-[1500ms] ease-in-out ${
                isPulseDark
          ...
          <div className="mt-8 animate-slide-up delay-500">
            <div className="flex justify-center items-center space-x-4 md:space-x-8">
              <div className="text-center">
                <div
                  className={`rounded-lg p-3 md:p-4 shadow-lg border transition-all duration-[1500ms] ease-in-out ${
                    isPulseDark
                  ...
                  <div
                    className={`text-xs md:text-sm uppercase tracking-wider transition-all duration-[1500ms] ease-in-out ${
              ...
              <div
                className={`text-2xl md:text-3xl animate-pulse transition-all duration-[1500ms] ease-in-out ${
        ...
        <div className="animate-slide-up delay-500">
          <div className="relative">
            <p className="text-2xl md:text-3xl lg:text-4xl font-medium text-gray-100 italic relative z-10 mb-8">
              <span
                className={`bg-clip-text text-transparent animate-gradient-shift transition-all duration-[1500ms] ease-in-out ${
                  isPulseDark
            ...
            <div
              className={`absolute -top-6 -left-6 text-7xl animate-float transition-all duration-[1500ms] ease-in-out ${
                isPulseDark ? 'text-gray-500/40' : 'text-red-500/40'
              }`}>
              "
            </div>
            <div
              className={`absolute -bottom-6 -right-6 text-7xl animate-float delay-1000 transition-all duration-[1500ms] ease-in-out ${
            ...
            {tabs.map((_, index) => (
              <button
                ...
                className={`w-12 h-2 rounded-full transition-all duration-500 hover:scale-110 ${
                  activeTab === index
                    ? `shadow-lg transition-all duration-[1500ms] ease-in-out ${
                        isPulseDark
            ...
            {tabs.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 hover:scale-125 ${
                  activeTab === index
                    ? `shadow-lg animate-pulse transition-all duration-[1500ms] ease-in-out ${
                        isPulseDark ? 'bg-gray-500 shadow-gray-500/50' : 'bg-red-500 shadow-red-500/50'
                      }`
            ...
            {tabs.map((tab, index) => (
              <div
                ...
                className={`absolute inset-0 transition-all duration-700 ${
                  activeTab === index ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-4'
                }`}>
                <div className="text-center space-y-4">
                  <h3
                    className={`text-3xl md:text-4xl font-bold bg-gradient-to-r ${tab.accent} bg-clip-text text-transparent animate-gradient-shift`}>
                    {tab.title}
                  </h3>
                  <p className="text-xl md:text-2xl text-gray-200 font-medium animate-pulse-text">{tab.subtitle}</p>
                  <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">{tab.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="animate-slide-up delay-1000">
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-4">
            ...
            <span
              className={`inline-block animate-fade-in-word delay-300 bg-clip-text text-transparent font-semibold transition-all duration-[1500ms] ease-in-out ${
                isPulseDark ? 'bg-gradient-to-r from-gray-400 to-gray-600' : 'bg-gradient-to-r from-red-400 to-red-600'
              }`}>
              extraordinary
            </span>{' '}
            ...
            <span
              className={`inline-block animate-fade-in-word delay-800 bg-clip-text text-transparent font-semibold transition-all duration-[1500ms] ease-in-out ${
                isPulseDark ? 'bg-gradient-to-r from-gray-500 to-gray-700' : 'bg-gradient-to-r from-red-500 to-red-700'
              }`}>
              e-commerce
            </span>
      ...
      <div
        className={`absolute top-16 left-8 w-4 h-4 rounded-full animate-float-random transition-all duration-[1500ms] ease-in-out ${
          isPulseDark ? 'bg-gray-500/50' : 'bg-red-500/50'
        }`}></div>
      <div
        className={`absolute top-32 right-16 w-3 h-3 rounded-full animate-float-random delay-500 transition-all duration-[1500ms] ease-in-out ${
          isPulseDark ? 'bg-gray-600/50' : 'bg-red-600/50'
        }`}></div>
      <div
        className={`absolute bottom-24 left-16 w-5 h-5 rounded-full animate-float-random delay-1000 transition-all duration-[1500ms] ease-in-out ${
          isPulseDark ? 'bg-gray-700/50' : 'bg-red-700/50'
        }`}></div>
      <div
        className={`absolute bottom-40 right-12 w-2 h-2 rounded-full animate-float-random delay-1500 transition-all duration-[1500ms] ease-in-out ${
          isPulseDark ? 'bg-gray-800/50' : 'bg-red-800/50'
        }`}></div>

      {/* Shooting stars effect with smooth theme transitions */}
      <div
        className={`absolute top-1/4 left-0 w-1 h-1 rounded-full animate-[shooting-star_3s_linear_infinite] transition-all duration-[1500ms] ease-in-out ${
          isPulseDark ? 'bg-gray-400' : 'bg-red-400'
        }`}></div>
      <div
        className={`absolute top-1/2 right-0 w-1 h-1 rounded-full animate-[shooting-star_4s_linear_infinite_1s] transition-all duration-[1500ms] ease-in-out ${
